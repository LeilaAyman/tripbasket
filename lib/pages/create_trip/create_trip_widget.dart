  ...
  Future<void> _createTrip() async {
    ...
    try {
      ...
      final tripData = createTripsRecordData(
        ...
        rating: 0.0,
        // TODO: Set agency reference based on current user's agency
        agencyReference: null, // This should be set based on authentication
      );

      // Add to Firestore
      await TripsRecord.collection.add(tripData);

...
class _HomeMobilePageState extends State<HomeMobilePage> with TickerProviderStateMixin {
  ...
  Widget _favoriteButton(TripsRecord trip) {
    ...
    if (userRef == null) return const SizedBox();
